...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'RegisterEmail',
          path: '/registerEmail',
          builder: (context, params) => const RegisterEmailWidget(),
        ),
        FFRoute(
          name: 'AddHelpRequestFull',
          path: '/addHelpRequestFull',
          requireAuth: true,
        ...
        FFRoute(
          ...
          path: '/requestOffers',
          requireAuth: true,
          builder: (context, params) => RequestOffersWidget(
            thisRequestDocRef: params.getParam('thisRequestDocRef',
                ParamType.DocumentReference, false, ['Request']),
          ),
        ),
        ...
        FFRoute(
          ...
          path: '/requestOfferDetail',
          requireAuth: true,
          builder: (context, params) => RequestOfferDetailWidget(
            offerDocRef: params.getParam(
                'offerDocRef', ParamType.DocumentReference, false, ['Offer']),
          ),
        ),
        FFRoute(
          name: 'ChatPage',
        ...
        FFRoute(
          ...
          builder: (context, params) => UserProfileWidget(
            userDocRef: params.getParam(
                'userDocRef', ParamType.DocumentReference, false, ['users']),
          ),
        ),
        FFRoute(
          name: 'MyOffers',
