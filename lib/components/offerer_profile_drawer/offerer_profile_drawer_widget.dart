...
class OffererProfileDrawerWidget extends StatefulWidget {
  const OffererProfileDrawerWidget({
    super.key,
  ...
  @override
  State<OffererProfileDrawerWidget> createState() =>
      _OffererProfileDrawerWidgetState();
}

class _OffererProfileDrawerWidgetState
    extends State<OffererProfileDrawerWidget> {
  late OffererProfileDrawerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OffererProfileDrawerModel());
