...
import '/components/map_drawer/map_drawer_widget.dart';
...
import 'request_detail_model.dart';
export 'request_detail_model.dart';
...
class _RequestDetailWidgetState extends State<RequestDetailWidget>
  ...
  late RequestDetailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RequestDetailModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<RequestRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final requestDetailRequestRecord = snapshot.data!;
              ...
              child: StreamBuilder<List<OfferRecord>>(
                stream: queryOfferRecord(
                  queryBuilder: (offerRecord) => offerRecord
                      ...
                      .where(
                        'RequestId',
                        isEqualTo: requestDetailRequestRecord.reference,
                      ),
                  singleRecord: true,
                ),
                builder: (context, snapshot) {
                  ...
                  return Column(
                    ...
                    children: [
                        ...
                        child: StreamBuilder<List<UsersRecord>>(
                          stream: queryUsersRecord(
                            queryBuilder: (usersRecord) => usersRecord.where(
                              'uid',
                              isEqualTo: requestDetailRequestRecord.userId?.id,
                            ),
                            singleRecord: true,
                          ),
                          builder: (context, snapshot) {
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Visibility(
                                      visible: requestDetailRequestRecord
                                          .isAudioFile,
                                      child: Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            10.0, 10.0, 10.0, 0.0),
                                                                        ...
                                                                        children: [
                                                                          Flexible(
                                                                            child:
                                                                              ...
                                                                              child: Text(
                                                                                requestDetailRequestRecord.address,
                                                                                textAlign: TextAlign.center,
                                                                          ...
                                                                          Text(
                                                                            valueOrDefault<String>(
                                                                              functions.distanceBetweenTwoPoints(requestDetailRequestRecord.location, currentUserLocationValue, ' Km'),
                                                                              'Unknown Distance',
                                                                            ),
                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                  fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                          ...
                                                                          if (requestDetailRequestRecord.startTimeAsap ==
                                                                              false)
                                                                            Text(
                                                                              valueOrDefault<String>(
                                                                                dateTimeFormat('MMMd h:mm a', requestDetailRequestRecord.startTime),
                                                                                'ASAP',
                                                                              ),
                                                              ...
                                                              builder:
                                                                ...
                                                                return AlertDialog(
                                                                  title: const Text(
                                                                      'Cannot withdraw'),
                                                                  content: const Text(
                                                                      'Your offer has already been accepted, you cannot withdraw from here. Converse with the requester.'),
                                                                  actions: [
                                                                    TextButton(
                                                                      onPressed:
                                                                          () =>
                                                                ...
                                                                await showDialog<
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return AlertDialog(
                                                                          ...
                                                                          content:
                                                                              const Text('Are you sure you want to withdraw your bid on this request?'),
                                                                          actions: [
                                                                            TextButton(
                      ...
                      InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          if (requestDetailRequestRecord.accepted) {
                            return;
                          }
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (requestDetailRequestRecord.accepted == true)
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 0.0, 4.0),
                                    child: Text(
